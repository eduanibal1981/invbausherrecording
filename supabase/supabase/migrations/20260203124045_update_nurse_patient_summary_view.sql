-- =============================================
-- Enhanced Nurse Patient Summary View
-- Tracks: assigned patients vs entries made by staff
-- Allows >100% achievement
-- =============================================
...
entries_by_staff AS (
    SELECT 
        bw.staffenter::bigint as staff_id,
...
LEFT JOIN entries_by_staff eb ON s.medicalstaffid = eb.staff_id
